                ...
                <div class="col-md-3">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                           ...
                           <a href="{{ route('tin-tuc.chi-tiet', ['news_slug' => $item->news_slug, 'news_id' => $item->news_id]) }}"> <p class="blog-name fw-bold">{{$item->news_title}}</p></a>
              ...
              <ul class="pagination justify-content-center">
                  <li class="">
                      <a class="page-link" href="#" aria-label="Previous">
                          <span aria-hidden="true" class="d-flex align-items-center"><img src="images/lefticon.svg" alt=""> <p class="mb-0">Trang trước</p></span>
                      </a>
                  </li>
                  ...
                  <li class="">
                      <a class="page-link" href="#" aria-label="Next">
                          <span aria-hidden="true" class="d-flex align-items-center"><p class="mb-0">Trang sau</p> <img src="images/righticon.svg" alt=""></span>
                      </a>
                  </li>
              </ul>
          </nav>
